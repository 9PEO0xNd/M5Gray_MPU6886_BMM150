...
void compassplot(float a) {
  ...
  //compass.pushImage(68+80*sin((a+345)*DEG_TO_RAD), 64-80*cos((a+345)*DEG_TO_RAD), 48, 48, ehou, 0); //2,7
  //compass.pushImage(68+80*sin((a+165)*DEG_TO_RAD), 64-80*cos((a+165)*DEG_TO_RAD), 48, 48, ehou, 0); //1,3,6,8
  compass.pushImage(68+80*sin((a+75)*DEG_TO_RAD), 64-80*cos((a+75)*DEG_TO_RAD), 48, 48, ehou, 0); //4,9
  //compass.pushImage(68+80*sin((a+255)*DEG_TO_RAD), 64-80*cos((a+255)*DEG_TO_RAD), 48, 48, ehou, 0); //0,5
